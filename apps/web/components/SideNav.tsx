    ...
    <nav className="flex flex-col gap-2">
      ...
      {isGM && (
        <>
		  ...
		  <Link href="/gm/generatore-mostri" className={linkCls('/gm/editor-clock')}>👹 Generatore Mostri</Link>
		  <Link href="/gm/editor-clock" className={linkCls('/gm/editor-clock')}>📝 Note (GM) - Update</Link>
